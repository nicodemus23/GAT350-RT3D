...
// cubemap sampler for the SaintPetersBasilica environment map
layout(binding = 4) uniform samplerCube SaintPetersBasilica;
...
void main()
{
	...
	//vec4 reflectedColor = vec4(1); //texture(SaintPetersBasilica, reflectionVector);
	vec4 reflectedColor = texture(SaintPetersBasilica, reflectionVector);
